...
export class Pages extends Message<Pages> {
  ...
  /**
   * @generated from field: repeated string page_urls = 2;
   */
  pageUrls: string[] = [];
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    ...
    { no: 2, name: "page_urls", kind: "scalar", T: 9 /* ScalarType.STRING */, repeated: true },
  ]);
...
export class NewDocumentationRequest extends Message<NewDocumentationRequest> {
  ...
  /**
   * @generated from field: optional bool publish_to_team = 7;
   */
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    ...
    { no: 7, name: "publish_to_team", kind: "scalar", T: 8 /* ScalarType.BOOL */, opt: true },
  ]);
