...
/**
 * @generated from message aiserver.v1.DownloadUpdateRequest
 */
export class DownloadUpdateRequest extends Message<DownloadUpdateRequest> {
  /**
  ...
  constructor(data?: PartialMessage<DownloadUpdateRequest>) {
    super();
    proto3.util.initPartial(data, this);
  }

  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "aiserver.v1.DownloadUpdateRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
  ...
  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): DownloadUpdateRequest {
    return new DownloadUpdateRequest().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): DownloadUpdateRequest {
    return new DownloadUpdateRequest().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): DownloadUpdateRequest {
    return new DownloadUpdateRequest().fromJsonString(jsonString, options);
  }

  static equals(a: DownloadUpdateRequest | PlainMessage<DownloadUpdateRequest> | undefined, b: DownloadUpdateRequest | PlainMessage<DownloadUpdateRequest> | undefined): boolean {
    return proto3.util.equals(DownloadUpdateRequest, a, b);
  }
}

/**
 * @generated from message aiserver.v1.DownloadUpdateResponse
 */
export class DownloadUpdateResponse extends Message<DownloadUpdateResponse> {
  /**
   * @generated from field: bool can_download = 1;
   */
  canDownload = false;

  constructor(data?: PartialMessage<DownloadUpdateResponse>) {
    super();
    proto3.util.initPartial(data, this);
  }

  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "aiserver.v1.DownloadUpdateResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "can_download", kind: "scalar", T: 8 /* ScalarType.BOOL */ },
  ]);

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): DownloadUpdateResponse {
    return new DownloadUpdateResponse().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): DownloadUpdateResponse {
    return new DownloadUpdateResponse().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): DownloadUpdateResponse {
    return new DownloadUpdateResponse().fromJsonString(jsonString, options);
  }

  static equals(a: DownloadUpdateResponse | PlainMessage<DownloadUpdateResponse> | undefined, b: DownloadUpdateResponse | PlainMessage<DownloadUpdateResponse> | undefined): boolean {
    return proto3.util.equals(DownloadUpdateResponse, a, b);
  }
}
