...
import { CmdKDebugInfo } from './cmdk_pb';
...
export class GetChatRequest extends Message<GetChatRequest> {
  ...
  /**
   * @generated from field: optional bool allow_long_file_scan = 13;
   */
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    ...
    { no: 13, name: "allow_long_file_scan", kind: "scalar", T: 8 /* ScalarType.BOOL */, opt: true },
  ]);
 ...
 */
export class CheckLongFilesFitResponse extends Message<CheckLongFilesFitResponse> {
  /**
   * @generated from field: bool did_fit = 1;
   */
  didFit = false;

  constructor(data?: PartialMessage<CheckLongFilesFitResponse>) {
    super();
    proto3.util.initPartial(data, this);
  }

  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "aiserver.v1.CheckLongFilesFitResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "did_fit", kind: "scalar", T: 8 /* ScalarType.BOOL */ },
  ]);

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): CheckLongFilesFitResponse {
    return new CheckLongFilesFitResponse().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): CheckLongFilesFitResponse {
    return new CheckLongFilesFitResponse().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): CheckLongFilesFitResponse {
    return new CheckLongFilesFitResponse().fromJsonString(jsonString, options);
  }

  static equals(a: CheckLongFilesFitResponse | PlainMessage<CheckLongFilesFitResponse> | undefined, b: CheckLongFilesFitResponse | PlainMessage<CheckLongFilesFitResponse> | undefined): boolean {
    return proto3.util.equals(CheckLongFilesFitResponse, a, b);
  }
}
...
export class StreamChatResponse extends Message<StreamChatResponse> {
  ...
  /**
   * @generated from field: optional aiserver.v1.DocsReference docs_reference = 9;
   */
