...
export class GetActivationCheckoutUrlRequest extends Message<GetActivationCheckoutUrlRequest> {
  ...
  /**
   * @generated from field: bool yearly = 3;
   */
  yearly = false;
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    ...
    { no: 3, name: "yearly", kind: "scalar", T: 8 /* ScalarType.BOOL */ },
  ]);
...
/**
 * @generated from message aiserver.v1.CreateTeamRequest
 */
export class CreateTeamRequest extends Message<CreateTeamRequest> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "aiserver.v1.CreateTeamRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "name", kind: "scalar", T: 9 /* ScalarType.STRING */ },
  ]);
...
/**
 * @generated from message aiserver.v1.CreateTeamResponse
 */
export class CreateTeamResponse extends Message<CreateTeamResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "aiserver.v1.CreateTeamResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "team_id", kind: "scalar", T: 5 /* ScalarType.INT32 */ },
  ]);
...
/**
 * @generated from message aiserver.v1.ChangeSeatRequest
 */
export class ChangeSeatRequest extends Message<ChangeSeatRequest> {
  /**
   * @generated from field: int32 team_id = 1;
   */
  teamId = 0;
  ...
  /**
   * @generated from field: int32 new_seats = 2;
   */
  newSeats = 0;

  constructor(data?: PartialMessage<ChangeSeatRequest>) {
    super();
    proto3.util.initPartial(data, this);
  }

  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "aiserver.v1.ChangeSeatRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "team_id", kind: "scalar", T: 5 /* ScalarType.INT32 */ },
    { no: 2, name: "new_seats", kind: "scalar", T: 5 /* ScalarType.INT32 */ },
  ]);

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): ChangeSeatRequest {
    return new ChangeSeatRequest().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): ChangeSeatRequest {
    return new ChangeSeatRequest().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): ChangeSeatRequest {
    return new ChangeSeatRequest().fromJsonString(jsonString, options);
  }

  static equals(a: ChangeSeatRequest | PlainMessage<ChangeSeatRequest> | undefined, b: ChangeSeatRequest | PlainMessage<ChangeSeatRequest> | undefined): boolean {
    return proto3.util.equals(ChangeSeatRequest, a, b);
  }
}

/**
 * @generated from message aiserver.v1.ChangeSeatResponse
 */
export class ChangeSeatResponse extends Message<ChangeSeatResponse> {
  /**
   * @generated from field: bool success = 1;
   */
  success = false;

  constructor(data?: PartialMessage<ChangeSeatResponse>) {
    super();
    proto3.util.initPartial(data, this);
  }

  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "aiserver.v1.ChangeSeatResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "success", kind: "scalar", T: 8 /* ScalarType.BOOL */ },
  ]);

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): ChangeSeatResponse {
    return new ChangeSeatResponse().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): ChangeSeatResponse {
    return new ChangeSeatResponse().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): ChangeSeatResponse {
    return new ChangeSeatResponse().fromJsonString(jsonString, options);
  }

  static equals(a: ChangeSeatResponse | PlainMessage<ChangeSeatResponse> | undefined, b: ChangeSeatResponse | PlainMessage<ChangeSeatResponse> | undefined): boolean {
    return proto3.util.equals(ChangeSeatResponse, a, b);
  }
}
