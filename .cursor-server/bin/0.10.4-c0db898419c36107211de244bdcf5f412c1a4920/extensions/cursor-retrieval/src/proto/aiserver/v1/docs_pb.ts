...
export class DocumentationMetadata extends Message<DocumentationMetadata> {
  ...
  /**
   * @generated from field: optional int32 team_id = 6;
   */
  teamId?: number;
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    ...
    { no: 6, name: "team_id", kind: "scalar", T: 5 /* ScalarType.INT32 */, opt: true },
  ]);
...
export class DocumentationChunk extends Message<DocumentationChunk> {
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    ...
    { no: 5, name: "page_title", kind: "scalar", T: 9 /* ScalarType.STRING */ },
  ]);
